...
export const jumpGame = {
    ...
    You are given an integer array <strong>nums</strong>. You are initially positioned at the <strong>first index</strong>
    and each element in the array represents your maximum jump length at that position.
  </p>
    <p class='mt-3'>
    Return <strong>true</strong> if you can reach the last index, or <strong>false</strong> otherwise.
    </p>
  `,
	...
	constraints: `<li class='mt-2'><strong>1 <= nums.length <= 10^4</strong></li>
    <li class='mt-2'><strong>0 <= nums[i] <= 10^5</strong></li>`,
